...
# one means "match on title alone".  PyCharm needs it: its frame and its shaped
# "Content window" helper share WM_CLASS "jetbrains-pycharm", the helper is
...
# PyCharm takes appreciably longer than an Electron editor to put its first window
