...
#
#   source measure.sh
#   start_app 'soffice --calc'     # launch and wait for the window
...
# The status bar is the cheapest ground truth a spreadsheet offers: the active
# sheet, the selected range, and the Sum/Average of the selection. Read it off
# the screenshot rather than trusting that a keystroke did what it looked like
# it did - a selection one row short reports a different sum, and nothing else
# on screen shows it.
STATUS() {
