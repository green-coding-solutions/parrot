...
# Flatpak sandboxes the filesystem. The workbook has to live somewhere the app
...
# workbook and write the exported PDF beside it. `chmod 644` alone is not
...
chown "${APP_UID}:${APP_UID}" /tmp/parrot-ledger.ods
